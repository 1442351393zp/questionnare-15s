...
<head>
    ...
    <style id="wj_skin_css">.btn, .page-btn {
    ...
    .ui-button-primary:hover, .ui-button-primary:active {
        background-color: rgba(36, 89, 219, 1);
        border-color: rgba(36, 89, 219, 1);
    }
    ...
    .s-page, .page, .page-survey, .cascade-pop-page, .page .page-end-content {
    ...
    .check-box .checkbox-icon, .checkbox-input:checked + .checkbox-cell .check-box .checkbox-icon {
        stroke: rgba(255, 255, 255, 1);
    }

    .selectbox, .question-select-list {
    ...
    .slider-tip:after {
        border-top-color: rgba(40, 99, 243, 1);
    }
    ...
    .slider-tip-num, .slider-handle-num {
        color: rgba(255, 255, 255, 1);
    }
    ...
    .checkbtn-input:checked + label strong, .checkbtn-input:checked + label strong span {
        color: rgba(255, 255, 255, 1);
    }
    ...
    .mod_fillblank.active {
        border-bottom-color: rgba(40, 99, 243, 1);
    }
    ...
    .page-cover-pic .laptop .quote-l-drop {
        border-top-color: rgba(40, 99, 243, 1);
        border-left-color: rgba(40, 99, 243, 1);
    }
    ...
    .icon-survey-gift, .page-cover .page-tip-gift .icon-survey-gift {
        fill: rgba(0, 0, 0, 1);
    }

    .top-tips-wrap .icon-close, .page-tip .icon-arrow-right, .reward-back .icon-arrow-left {
...
<body class="survey-pc skin stopPoint">
                ...
                <div class="survey-header">
                    ...
                    <div class="page-cover-pic">
                        <div class="laptop anim">
                            ...
                            <div class="hook">
                                <div class="paper"><span class="paper-line l1"></span><span
                                        class="paper-line l2"></span><span class="paper-line l3"></span><span
                                        class="paper-line l4"></span><span class="paper-line l5"></span><span
                                        class="paper-line l6"></span><span
                            ...
                            <div class="quote-l">
                                ...
                                <span class="quote-l-line l1"></span><span class="quote-l-line l2"></span><span
                                    class="quote-l-line l3"></span>
                            </div>
                            <div class="quote-r">
                                <div class="quote-r-bg "></div>
                                <span class="quote-r-dot d1 " style="transition: background 0.2s ease 0s;"></span><span
                                    class="quote-r-dot d2 " style="transition: background 0.2s ease 0s;"></span><span
                                    class="quote-r-dot d3 "
                    ...
                    <form id="formData" method="post" enctype="application/x-www-form-urlencoded">
                        ...
                        <input id="receiverId" name="receiverId" type="hidden" value="${reelVo.receiverId}"/>
                        <input id="optionsIds" name="optionsIds" type="hidden"/>
                        <input id="textAnswerList" name="textAnswerList" type="hidden"/>
                        <input id="subjectIds" name="subjectIds" type="hidden"/>
                        <input id="pageIds" name="pageIds" type="hidden"/>
                        <input type="hidden" id="stop" value="${stop}">
                        <input type="hidden" id="answerflag" value="${answerflag}">
                        <input type="hidden" id="startTime" name="startTime">
                        <input type="hidden" id="endTime" name="endTime">
                        <input type="hidden" id="timeConsuming" name="timeConsuming">
                        <input type="hidden" id="oobjectstr" name="oobjectstr">
                    </form>
                    <input id="pageNum" name="pageNum" type="hidden" value="${reelVo.pageMaxNo}"/>
                </div>
                <!-- 填报问卷的题目内容 -->
                <%--<c:if test="${reelVo.showNo == 0}">--%>
                    ...
                    <div class="survey-main s-main">
                        <div class="progress">
                            <div class="progress-bar s-prog-wait fixed-bar">
                                <div class="progress-done  s-prog-done">
                                    <input type="hidden" value="${pages.pageId}">
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="question-item-content">
                                                <c:forEach items="${subject.optionsList}" var="options">
                                                    <div class="radio-primary radio-btn">
                                                        ...
                                                        <input type="radio" name="options${subject.subNo}"
                                                               id="${options.optionsId}"
                                                               data-question-type="${subject.subjectType}"
                                                               data-must="${subject.must}"
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${options.isMultipleChoice == 0}">
                                                            <div class="checkbox-primary checkbox-btn"
                                                                 style="display: flex;">
                                                                <input name="isMultipleChoice" type="hidden"
                                                                       value="${options.isMultipleChoice}"/>
                                                                <input type="checkbox"
                                                                ...
                                                                <div class="wrap-other">
                                                                    ...
                                                                    <label class="textarea-other"
                                                                           contenteditable="true">${options.options}</label>
                                                                </div>
                                                            </div>
                                                        </c:when>
                                                        <%--正常选项--%>
                                                        <c:otherwise>
                                                            <div class="checkbox-primary checkbox-btn">
                                                                <input name="isMultipleChoice" type="hidden"
                                                                       value="${options.isMultipleChoice}"/>
                                                                <input type="checkbox" id="${options.optionsId}"
                                                                       name="options${subject.subNo}"
                                                                       data-question-type="${subject.subjectType}"
                                                                       data-must="${subject.must}"
                                                                       value="${options.optionsId}"/>
                        ...
                        <div class="page-control">
                            <div class="page-control-btn-group">
                                ...
                                <button class="btn-submit nextPage" index-page=${status.index} signIndex=0>
...
<div class="end-box" style="display: none;">
    ...
    <%--<h1>问卷到此结束，感谢您的参与！</h1>--%>
    <%--<a href="/questionnaire/login/index">
        &lt;%&ndash;onclick="javascript:history.go(-2);location.reload();"&ndash;%&gt;
        <div class="btn-submit" style="line-height: 40px;" >回到主页面</div>
    </a>--%>
